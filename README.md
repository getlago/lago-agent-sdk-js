...
| `packages/gateway` | The AI Gateway for Billing (beta, in progress). An OpenAI-compatible endpoint that authenticates Lago virtual keys, proxies to providers, and emits priced, attributed usage events with durable delivery. |
